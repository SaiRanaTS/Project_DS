...
global n
global count
def find_gps_port_value(actor, port_type, port_name_ls,n,num,count):
    ...
    print('Tag:',count)
    if n == 0:
        print('The GPS info of Own Ship :')
        print(result[0][0])
        print(num+1)


    elif n == 1:
        print('The GPS info of TS1 :')
        print(result[0])
        print(num + 1)

    elif n == 2:
        print('The GPS info of TS2 :')
        print(result[0])
        print(num + 1)

    elif n == 3:
        print('The GPS info of TS3 :')
        print(result[0])
        print(num + 1)

    elif n == 4:
        print('The GPS info of TS4 :')
        print(result[0])
        print(num + 1)

    elif n == 5:
        print('The GPS info of TS5 :')
        print(result[0])
        print(num + 1)
...
async def start():
    ...
    actor_info_list = [gps_gunnerus, gps_target_ship_1, gps_target_ship_2, gps_target_ship_3, gps_target_ship_4,
                       gps_target_ship_5, gunnerus_thruster_port, gunnerus_thruster_starboard]
    actuator_get_json = []
    port_value = []
    n = 0
    num = 0
            ...
            if not websocket.open:
                ...
                try:
                    ...
                    for i in range(8):
                        ...
                        actor = await evaluate_actor(data_dic, actor_info['clazz'],
                                                     actor_info['name'])  # out the dic data type
                        ...
                        if actor != None:
                            ...
                            if actor['name'] == 'Starboard' or actor['name'] == 'Port':
                                ...
                                gps_port_value = find_gps_port_value(actor, 'output', port_gps_name_ls,n,num,count)
